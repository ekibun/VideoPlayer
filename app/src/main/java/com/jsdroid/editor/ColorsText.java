...
public class ColorsText extends AppCompatEditText {
    ...
    private int lineNumberColor = 0xff6ea6b8;
    private int cursorColor = 0xff0b216f;
    private int selectBackgroundColor = 0x33add6ff;
    ...
    private void init() {
        ...
        setPadding(0, 0, DpiUtils.dip2px(getContext(), 8), 0);
    }
    ...
    private void drawText(Canvas canvas) {
        ...
        for (int lineNum = firstLine; lineNum <= lastLine
            ...
            if (lineNum == selectLine) {
                ...
                canvas.drawRect(0, ltop, getRight(), lbottom, paint);
            }
            // 绘制行号
